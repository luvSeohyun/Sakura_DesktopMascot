...
Shader "Custom/Screen Space Shadow AA Correction"
{
    Properties
    {
        [Toggle(SHADOWTEST)]_ShadowTest ("_ShadowTest", float) = 0
        [Toggle(_SHADOWS_SCREEN)]_On ("On", float) = 0
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile _ SHADOWTEST
            ...
            fixed4 frag(v2f i): SV_Target
            {
                    ...
                    if (depthDiff > diffTest)
                    {
                        ...
                        float diffs[4] = {
                            offsetDiffs.x, offsetDiffs.y, offsetDiffs.z, offsetDiffs.w
                        };
